 ...
 */
class ArucoDetector : public Algorithm
{
public:
     ...
     */
    ArucoDetector(const Dictionary &dictionary = getPredefinedDictionary(cv::aruco::DICT_4X4_50),
     ...
     */
    void refineDetectedMarkers(InputArray image, const Board &board,
    ...
    */
    inline void write(FileStorage& fs, const String& name) { Algorithm::write(fs, name); }
