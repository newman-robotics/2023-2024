...
class CharucoDetector : public Algorithm {
public:
     ...
     */
    CharucoDetector(const CharucoBoard& board,
     ...
     */
    void detectDiamonds(InputArray image, OutputArrayOfArrays diamondCorners, OutputArray diamondIds,
                                InputOutputArrayOfArrays markerCorners = noArray(),
                                InputOutputArray markerIds = noArray()) const;
protected:
